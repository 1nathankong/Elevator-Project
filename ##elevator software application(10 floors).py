...
class Elevator:
    ...
    def set_current_floor(self, first_floor_clicked: bool, second_floor_clicked: bool, third_floor_clicked: bool, fourth_floor_clicked: bool, fifth_floor_clicked: bool, sixth_floor_clicked: bool, seventh_floor_clicked: bool, eighth_floor_clicked: bool, ninth_floor_clicked: bool, tenth_floor_clicked: bool):
        ...
        if fifth_floor_clicked:
            self.current_floor = 5
        if sixth_floor_clicked:
            self.current_floor = 6 
        if seventh_floor_clicked:
            self.current_floor = 7
        if eighth_floor_clicked:
            self.current_floor = 8
        if ninth_floor_clicked:
            self.current_floor = 9 
        if tenth_floor_clicked:
            self.current_floor = 10 

    def get_current_floor(self):
        return self.current_floor
    
    def set_floor_input(self, first_floor_clicked: bool, second_floor_clicked: bool, third_floor_clicked: bool, fourth_floor_clicked: bool, fifth_floor_clicked: bool, sixth_floor_clicked: bool, seventh_floor_clicked: bool, eighth_floor_clicked: bool, ninth_floor_clicked: bool, tenth_floor_clicked: bool): ##one implementation is that i can reverse the for loop 
        if first_floor_clicked:
        ...
        if fifth_floor_clicked:
            self.floor_input.append(5)
        if sixth_floor_clicked:
            self.floor_input.append(6)
        if seventh_floor_clicked:
            self.floor_input.append(7)
        if eighth_floor_clicked:
            self.floor_input.append(8)
        if ninth_floor_clicked:
            self.floor_input.append(9) 
        if tenth_floor_clicked:
            self.floor_input.append(10)
    ...
    def ten_floor_operation(self, direction: int, first_floor_clicked: bool, second_floor_clicked: bool, third_floor_clicked: bool, fourth_floor_clicked: bool, fifth_floor_clicked: bool, sixth_floor_clicked: bool, seventh_floor_clicked: bool, eighth_floor_clicked: bool, ninth_floor_clicked: bool, tenth_floor_clicked: bool):
        ##first get the direction of the elevator
        self.set_direction(direction)
        self.set_floor_input(first_floor_clicked, second_floor_clicked, third_floor_clicked, fourth_floor_clicked, fifth_floor_clicked, sixth_floor_clicked, seventh_floor_clicked, eighth_floor_clicked, ninth_floor_clicked, tenth_floor_clicked)
            ...
            for second_floor_clicked in [False, True]:
                for third_floor_clicked in [False, True]:
                    for fourth_floor_clicked in [False, True]:
                        for fifth_floor_clicked in [False, True]:
                            for sixth_floor_clicked in [False, True]:
                                for seventh_floor_clicked in [False, True]: 
                                    for eighth_floor_clicked in [False, True]:
                                        for ninth_floor_clicked in [False, True]: 
                                            for tenth_floor_clicked in [False, True]:
                                                counter += 1
                                                
                                                print(f"Testing with direction = {direction}, "
                                                    f"first_floor_clicked={first_floor_clicked}, "
                                                    f"second_floor_clicked={second_floor_clicked}, "
                                                    f"third_floor_clicked={third_floor_clicked}, "
                                                    f"fourth_floor_clicked={fourth_floor_clicked}, "
                                                    f"fifth_floor_clicked={fifth_floor_clicked}, "
                                                    f"sixth_floor_clicked={sixth_floor_clicked}, "
                                                    f"seventh_floor_clicked={seventh_floor_clicked}, "
                                                    f"eighth_floor_clicked={eighth_floor_clicked}, "
                                                    f"ninth_floor_clicked={ninth_floor_clicked}, "
                                                    f"tenth_floor_clicked={tenth_floor_clicked}")
                                                """
                                                tester.ten_floor_operation(direction, first_floor_clicked, second_floor_clicked, third_floor_clicked, fourth_floor_clicked, fifth_floor_clicked, sixth_floor_clicked, seventh_floor_clicked, eighth_floor_clicked, ninth_floor_clicked, tenth_floor_clicked)
