...
HLS_SOURCES = ../../../../../elevator_hls_tb.cpp ../../../../../elevator_hls.cpp
...
$(ObjDir)/elevator_hls_tb.o: ../../../../../elevator_hls_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../elevator_hls_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/elevator_hls_tb.d

$(ObjDir)/elevator_hls.o: ../../../../../elevator_hls.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../elevator_hls.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/elevator_hls.d
